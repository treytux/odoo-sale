...
# class sale_report_profit_margin(osv.osv):
#     _name = "sale.report.profit.margin"
#     _description = "Sales orders profit margin statistics"
#     _auto = False
#     _rec_name = 'date'
...
#     def init(self, cr):
#         # self._table = sale_report_profit_margin
